...
export const createProductDto = z.object({
  ...
  unit: z.enum(['UN', 'KG', 'L', 'M', 'M2', 'M3', 'PC', 'CX', 'PCT'], {
  ...
  maxStock: z.number().int().min(0, 'Estoque máximo deve ser um número inteiro maior ou igual a zero').optional().nullable(),
...
export const productFiltersDto = z.object({
  ...
  isService: z.preprocess((val) => val === 'true', z.boolean()).optional(),
  hasVariations: z.preprocess((val) => val === 'true', z.boolean()).optional(),
