...
export class EmployeeService {
  ...
  async create(
    ...
    // Validar permissão
    await this.roleService.checkPermission({ userId, permission: 'create', resource: 'employee' });
  ...
  async findById(
    ...
    // Validar permissão
    await this.roleService.checkPermission({ userId, permission: 'read', resource: 'employee' });
  ...
  async update(
    ...
    // Validar permissão
    await this.roleService.checkPermission({ userId, permission: 'update', resource: 'employee' });
  ...
  async delete(id: string, companyId: string, userId: string): Promise<void> {
    // Validar permissão
    await this.roleService.checkPermission({ userId, permission: 'delete', resource: 'employee' });
